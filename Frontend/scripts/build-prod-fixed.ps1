...
if (-not (Test-Path ".env.production")) {
    Write-Host "⚠️  Warning: .env.production not found. Using .env.production.sample as template." -ForegroundColor Yellow
...
if ($start -match "^[Yy]") {
    ...
    Write-Host "ℹ️  To start production containers later, run:" -ForegroundColor Yellow
